    ...
    for root, dirs, files in sorted(os.walk(folder_path)):
        for file_name in files:
            if file_name.endswith('.json'):
                ...
                #    count +=1
                    #print(file_name)
                lines_in_file_1 = count_lines_in_json(file_path_1)
                lines_in_file_2 = count_lines_in_json(file_path_2)
                if lines_in_file_1 != lines_in_file_2:
                #print("{}:{}".format(file_name,lines_in_file))
                #total_lines += lines_in_file
                #count +=1
                    print(f"File: {file_name} - Lines: {lines_in_file_1}- Lines: {lines_in_file_2}")
...
if __name__ == '__main__':
    ...
    folder_path2 = '/home/dengyiru/vip_crwal/new_picture'  # 更改为你的文件夹路径 171 42 27 19
    ...
    a = main(folder_path1,folder_path2)